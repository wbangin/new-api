...
type Token struct {
	...
	LogRequestEnabled  bool           `json:"log_request_enabled"` // 是否记录请求/响应内容到本地日志文件
...
func (token *Token) Update() (err error) {
	...
	err = DB.Model(token).Select("name", "status", "expired_time", "remain_quota", "unlimited_quota",
		"model_limits_enabled", "model_limits", "allow_ips", "group", "cross_group_retry", "log_request_enabled").Updates(token).Error
	return err
}
